...
//   );
        ...
        const response = await fetch(
          `${BASE_URL}/api/banners/update/${props.id}`,
          {
            method: "POST",
            headers: {
    ...
    const getPreFilledData = async () => {
      ...
      try {
        const response = await fetch(
          `${BASE_URL}/api/banners/show/${props.id}`,
          {
            method: "POST",
            headers: {
        ...
        if (!response.ok) {
          ...
          console.log(data.data);
            setImage(`${BASE_URL}/${data.data.attachurl}`)
            setTitle(data.data.title.fa)
            setdesc1(data.data.desc1.fa)
            setdesc2(data.data.desc2.fa)
            setdesc3(data.data.desc3.fa)
            setdesc4(data.data.desc4.fa)
            setbannerLink(data.data.link.fa)
            setLinktext(data.data.linktext.fa)
            setclickLimit(data.data.clicklimit)
            setPreview(`${BASE_URL}/${data.data.attachurl}`)
