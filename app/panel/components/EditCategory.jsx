  ...
  const token = usetokenStore((state) => state.Melotoken);
   ...
   const UpdateForm = async () => {
      try {
        ...
        formData.append("parent_id", MotherCat);
        ...
        const response = await fetch(
          `${BASE_URL}/api/categories/update/${props.id}`,
          {
            method: "POST",
            headers: {
      ...
      const getPreFilledData = async () => {
          ...
          try {
            const response = await fetch(
              `${BASE_URL}/api/categories/show/${props.id}`,
              {
                method: "POST",
                headers: {
            ...
            if (!response.ok) {
              ...
              setcatTitle(data.data.title.fa);
              setdescription(data.data.description.fa)
              setSeoTags(data.data.seo_tag.fa)
              setSeoDesc(data.data.seo_meta.fa)
              setImage(data.data.image)
              setPreview(data.data.image)
              setBannerimage(data.data.hero_image)
              setBannerpreview(data.data.hero_image)
